...
## Constraints
- Research only — no code, no planning yet
- Consider the current stack (tRPC, Supabase, Expo Router) — proposals should be buildable
- Admin panel serves content creators (Sammy + potentially others later)
