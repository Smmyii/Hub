...
**Files:**
- Create: `~/Documents/Config/workspace-manager/Cargo.toml`
- Create: `~/Documents/Config/workspace-manager/src/lib.rs`
- Create: `~/Documents/Config/workspace-manager/.cargo/config.toml`

- [ ] **Step 1: Create project directory**
  ```bash
  mkdir -p ~/Documents/Config/workspace-manager/src
  mkdir -p ~/Documents/Config/workspace-manager/.cargo
  cd ~/Documents/Config/workspace-manager
  git init
  ```
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/workspace.rs`
- Create: `~/Documents/Config/workspace-manager/src/config.rs`
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/state_file.rs`
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/app_state.rs`
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/pipe.rs`
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/undo.rs`
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/src/render.rs`
...
**Files:**
- Modify: `~/Documents/Config/workspace-manager/src/lib.rs`
...
- [ ] **Step 1: Overwrite lib.rs with full implementation**
  ...
  Overwrite `~/Documents/Config/workspace-manager/src/lib.rs`:
  ```rust
  mod app_state;
  mod config;
  mod pipe;
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/workspace-manager.kdl` (Zellij layout file)
...
- [ ] **Step 2: Create Zellij layout that loads the plugin**
  ...
  Create `~/Documents/Config/workspace-manager/workspace-manager.kdl`:
  ```kdl
  layout {
      pane size=28 {
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/wm-notify`
...
- [ ] **Step 2: Make executable**
  ```bash
  chmod +x ~/Documents/Config/workspace-manager/wm-notify
  ```

- [ ] **Step 3: Manual test outside Zellij**
  ```bash
  ~/Documents/Config/workspace-manager/wm-notify waiting
  ```
...
**Files:**
- Create: `~/Documents/Config/workspace-manager/install.sh`
...
- [ ] **Step 2: Make executable**
  ```bash
  chmod +x ~/Documents/Config/workspace-manager/install.sh
  ```

- [ ] **Step 3: Dry-run test**
  ```bash
  bash -n ~/Documents/Config/workspace-manager/install.sh
  ```
  Expected: no syntax errors

- [ ] **Step 4: Run install**
  ```bash
  ~/Documents/Config/workspace-manager/install.sh
  ```
...
- [ ] **Step 1: Launch workspace-manager in Zellij**
  ```bash
  zellij --layout ~/Documents/Config/workspace-manager/workspace-manager.kdl
  ```
